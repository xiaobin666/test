...
'''
file_directory = r'C:\Users\Administrator\Desktop\Data\HandledData\4AP\UnFilted'
figure_directory = r'C:\Users\Administrator\Desktop\Localization\4AP\UnFilted'
...
for k in range(3,4):
    ...
    writer = pd.ExcelWriter(r'C:\Users\Administrator\Desktop\Localization\4AP\UnFilted'+'\\'+'Distance-Error.xlsx')
