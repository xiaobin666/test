...
'''
file_directory = r'C:\Users\Administrator\Desktop\RSS-data\4AP\HandleData\Filted'
figure_directory = r'C:\Users\Administrator\Desktop\Rss-Localization\4AP'
...
for k in range(3,6):
    ...
    # # 画点误差图
    dataframe.insert(k-3,'K = '+str(k),distance_error_copy)

writer = pd.ExcelWriter(r"C:\Users\Administrator\Desktop\DistanceError\4AP-Filted.xlsx" )
