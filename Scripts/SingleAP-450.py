...
figure_directory = r'C:\Users\Administrator\Desktop\Localization\SingleAP\450°\Gauss-Filter'
def WKNN( file , ls ,k ):   #file为文件名：xxxx.xlsx
    ...
    for i in range(k):
        if list_min[i]==0:
            weighted.append( (quanzhi/2)/denominator)
        else:
...
for k in range(3,4):
    ...
    writer = pd.ExcelWriter(r'C:\Users\Administrator\Desktop\Localization\SingleAP\450°\Gauss-Filter' + '\\' + 'Distance-Error.xlsx')
